    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child(tp).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (getquestion != null && getop1 != null && getop2 != null && getop3 != null && getop4 != null && correct != null) {
                    ...
                    Toast.makeText(Question5.this, "Erreur: Une question ou une option manque.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Question5.this, "Erreur lors du chargement des questions.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        new CountDownTimer(timerDuration, ticksInterval) {
            ...
            public void onFinish() {
                Intent i1 = new Intent(getApplicationContext(), Bonus.class);
